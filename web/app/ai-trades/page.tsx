    ...
    <div className="min-h-screen px-6 pb-16">
      <header className="max-w-6xl mx-auto py-8 flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-3xl font-semibold mt-2">AI 交易历史</h1>
          <p className="text-sm text-white/60 mt-1">仅展示 Agent 自动交易记录</p>
        </div>
        <Link
          href="/golden-dogs"
      ...
      <main className="max-w-6xl mx-auto grid gap-6">
        ...
        <section className="grid gap-4 md:grid-cols-3">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            <p className="text-xs text-white/50">总交易数</p>
            <p className="text-2xl font-semibold text-white mt-2">{stats.count}</p>
          </div>
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            <p className="text-xs text-white/50">胜率</p>
            <p className="text-2xl font-semibold text-white mt-2">
              {(stats.winRate * 100).toFixed(1)}%
            </p>
          </div>
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            <p className="text-xs text-white/50">平均盈亏</p>
            <p className="text-2xl font-semibold text-white mt-2">
        ...
        <section className="grid gap-4 md:grid-cols-2">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            <h2 className="text-lg font-semibold text-white mb-3">分策略胜率</h2>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            <h2 className="text-lg font-semibold text-white mb-3">周期收益</h2>
            <div className="grid gap-2 text-sm text-white/70">
            ...
            >
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="text-right">
                  <p className="text-xs text-white/50">盈亏</p>
                  <p
              ...
              <div className="grid gap-4 md:grid-cols-4 mt-4 text-sm text-white/70">
                <div>
                  <p className="text-white/50 text-xs">
                    成交金额 ({trade.type === 'BUY' ? 'BNB' : 'Token'})
                  </p>
                  <p className="text-white">{trade.amount_in || 'N/A'}</p>
                </div>
                <div>
                  <p className="text-white/50 text-xs">
                    实际成交 ({trade.type === 'BUY' ? 'Token' : 'BNB'})
                  </p>
                ...
                <div>
                  <p className="text-white/50 text-xs">策略</p>
